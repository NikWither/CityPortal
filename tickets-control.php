...
<head>
    ...
    ?>
    <title>Управления заявками</title>
</head>
<body>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li>
                                                <form action="/actions/tickets/change_tag.php" method="post">
                                                    ...
                                                    <input type="hidden" name="tag" value="<?= $config['success_ticket_tag'] ?>">
                                                    <button class="dropdown-item" type="submit">Выполнено</button>
                                                </form>
                                            <li>
                                                <form action="/actions/tickets/change_tag.php" method="post">
                                                    <input type="hidden" name="id" value="<?= $ticket['id'] ?>">
                                                    <input type="hidden" name="tag" value="<?= $config['in_progress_ticket_tag'] ?>">
                                            ...
                                            <li>
                                                <form action="/actions/tickets/change_tag.php" method="post">
                                                    <input type="hidden" name="id" value="<?= $ticket['id'] ?>">
                                                    <input type="hidden" name="tag" value="<?= $config['reject_ticket_tag'] ?>">
